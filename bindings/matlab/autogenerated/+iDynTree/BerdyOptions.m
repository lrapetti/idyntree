classdef BerdyOptions < SwigRef
  methods
    ...
    function varargout = includeCoMAccelerometerAsSensorInTask1(self, varargin)
      narginchk(1, 2)
      if nargin==1
        nargoutchk(0, 1)
    ...
    function varargout = includeCoMAccelerometerAsSensorInTask2(self, varargin)
      narginchk(1, 2)
      if nargin==1
        nargoutchk(0, 1)
    ...
    function varargout = stackOfTasksMAP(self, varargin)
      narginchk(1, 2)
      if nargin==1
        nargoutchk(0, 1)
